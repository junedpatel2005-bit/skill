...
import { o as SiteHeader, v as logoutAction, D as Dialog, b as DialogContent, e as DialogHeader, f as DialogTitle, c as DialogDescription, d as DialogFooter, u as formatApproximateLocation, S as SiteFooter, s as createSsrRpc } from "./router-CCfZqKWO.js";
import { useNavigate, Link, getRouteApi } from "@tanstack/react-router";
import { X, Search, SlidersHorizontal, Save, BookmarkCheck, Trash2, Map, Heart, MapPin, CalendarClock, Paperclip, Briefcase, Star, Clock, ExternalLink, ShieldCheck, Award, Mail, Phone, UserRound, FileText, FileBadge, Camera } from "lucide-react";
...
function Landing() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      })() }) }) : /* @__PURE__ */ jsx("section", { className: "border-b border-border bg-surface", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-primary/15 bg-primary/5 px-5 py-4", children: /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold tracking-tight text-primary", children: user ? `Welcome, ${welcomeName || "there"}` : "Welcome to Servio" }) }) }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: isProfessional ? "" : "grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_400px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card p-5 shadow-soft", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between gap-3 sm:flex-row sm:items-center", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: isProfessional ? "Client job feed" : "Active job posts" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm leading-6 text-muted-foreground", children: isProfessional ? "Review client requirements, budget, deadline, files, and location before opening a job." : "These records come from the saved jobs table and are visible to professionals." })
            ] }),
            /* @__PURE__ */ jsxs(Button, { type: "button", variant: "outline", className: "gap-2", onClick: () => setShowJobsMap((value) => !value), children: [
          ...
          openJobs.length ? filteredOpenJobs.length ? showJobsMap ? /* @__PURE__ */ jsx("div", { className: "mt-5 overflow-hidden rounded-xl border border-border bg-background", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_340px]", children: [
          ...
          ] }) }) : /* @__PURE__ */ jsx("div", { className: "mt-5 grid auto-rows-fr gap-4 xl:grid-cols-2", children: filteredOpenJobs.map((job) => /* @__PURE__ */ jsxs(Link, { to: "/job/$jobId", params: {
            jobId: String(job.id)
          }, className: "relative flex min-h-[230px] flex-col rounded-xl border border-border bg-background p-5 pr-16 transition-colors hover:border-primary/50 hover:bg-primary/5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
              /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: job.category }),
              /* @__PURE__ */ jsx(Badge, { variant: job.urgency === "HIGH" ? "destructive" : "outline", children: formatEnum(job.urgency) }),
              /* @__PURE__ */ jsx(Badge, { children: formatWorkMode(job.workMode) }),
              favoriteIds.includes(job.id) ? /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: "Saved" }) : null
            ] }),
            /* @__PURE__ */ jsx("button", { type: "button", onClick: (event) => {
              event.preventDefault();
              event.stopPropagation();
              void toggleFavoriteJob(job.id);
            }, className: `absolute right-4 top-4 grid h-9 w-9 place-items-center rounded-lg border transition-colors ${favoriteIds.includes(job.id) ? "border-primary bg-primary/10 text-primary" : "border-border bg-card text-muted-foreground hover:text-primary"}`, "aria-label": favoriteIds.includes(job.id) ? "Remove favorite job" : "Save favorite job", children: /* @__PURE__ */ jsx(Heart, { className: `h-4 w-4 ${favoriteIds.includes(job.id) ? "fill-current" : ""}` }) }),
            /* @__PURE__ */ jsx("h3", { className: "mt-3 line-clamp-2 text-lg font-semibold", children: job.title }),
            /* @__PURE__ */ jsx("p", { className: "mt-2 line-clamp-2 text-sm leading-6 text-muted-foreground", children: job.description }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4 grid gap-2 text-sm text-muted-foreground sm:grid-cols-2", children: [
              /* @__PURE__ */ jsx("span", { children: formatBudget(job.budgetMin, job.budgetMax, job.timingType) }),
            ...
            /* @__PURE__ */ jsxs("p", { className: "mt-auto border-t border-border pt-3 text-xs text-muted-foreground", children: [
              "Posted by ",
        ...
        !isProfessional ? /* @__PURE__ */ jsx("aside", { className: "rounded-xl border border-border bg-card p-5 shadow-soft lg:sticky lg:top-6 lg:max-h-[calc(100vh-3rem)] lg:overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: "Professionals" }) }),
              /* @__PURE__ */ jsxs(Badge, { variant: "secondary", children: [
                filteredProfessionals.length,
                " results"
              ] })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "mt-4 flex h-11 items-center gap-2 rounded-xl border border-input bg-background px-3 text-sm shadow-soft", children: [
              /* @__PURE__ */ jsx(Search, { className: "h-4 w-4 text-muted-foreground" }),
              /* @__PURE__ */ jsx("input", { value: professionalSearch, onChange: (event) => setProfessionalSearch(event.target.value), placeholder: "Search name, skill, location", className: "min-w-0 flex-1 bg-transparent outline-none placeholder:text-muted-foreground" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: [["all", "All"], ["name", "Name"], ["skill", "Skill"], ["company", "Company"], ["location", "Location"]].map(([value, label]) => /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setProfessionalSearchFilter(value), className: `rounded-full px-3 py-1 text-xs font-medium transition-colors ${professionalSearchFilter === value ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary"}`, children: label }, value)) })
          ] }),
          professionals.length ? filteredProfessionals.length ? /* @__PURE__ */ jsx("div", { className: "grid gap-4", children: filteredProfessionals.map((professional) => {
            const fullName = `${professional.firstName} ${professional.lastName}`.trim();
            const verificationMeta = getVerificationMeta(professional.verification?.status);
            return /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border bg-background p-4 transition-colors hover:border-primary/50 hover:bg-primary/5", children: /* @__PURE__ */ jsxs("button", { type: "button", "aria-label": `Open ${fullName || "professional"} side profile`, onClick: () => {
              setSelectedProfessional(professional);
              setIsSheetOpen(true);
            }, className: "w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsx("img", { src: professional.avatarUrl || `https://i.pravatar.cc/100?u=pro-${professional.id}`, alt: fullName, className: "h-12 w-12 rounded-xl object-cover" }),
                /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 items-center gap-2", children: [
                    /* @__PURE__ */ jsx("h3", { className: "truncate font-semibold", children: fullName || "Professional" }),
                    /* @__PURE__ */ jsx("span", { className: `shrink-0 rounded-full px-2 py-0.5 text-[11px] font-semibold ${verificationMeta.badgeClass}`, children: verificationMeta.shortLabel })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "truncate text-sm text-muted-foreground", children: professional.industry || professional.companyName || "Professional account" })
                ] })
              ] }),
          ...
          }) }) : /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-dashed border-border bg-muted/30 p-6 text-center", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Try another search." })
          ] }) : /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-dashed border-border bg-muted/30 p-6 text-center", children: [
            /* @__PURE__ */ jsx(Search, { className: "mx-auto h-8 w-8 text-muted-foreground" }),
            /* @__PURE__ */ jsx("h3", { className: "mt-3 font-semibold", children: "No professionals saved yet" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Professional accounts will appear here." })
          ] }),
          /* @__PURE__ */ jsx(Button, { type: "button", variant: "outline", className: "w-full", onClick: () => setProfessionalSearch(""), disabled: !professionalSearch, children: "Clear search" })
        ] }) }) : null
      ] }) })
    ] }),
