...
import { J as useAppDispatch, K as useAppSelector, a as AuthLayout, F as Form, i as FormField, j as FormItem, k as FormLabel, g as FormControl, l as FormMessage, q as clearLoginFeedback, y as setLoginSubmitting, x as setLoginSubmitError, z as setLoginSuccessMessage, s as createSsrRpc } from "./router-CCfZqKWO.js";
...
function Login() {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      const nextRoute = result.user.role === "ADMIN" ? "/" : result.user.role === "CLIENT" ? "/" : "/professional-profile";
